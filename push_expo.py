...
def enviar_push(push_token: str, titulo: str, corpo: str, dados: dict | None = None, canal: str = "padrao1") -> None:
    """Manda push pra um único dispositivo. `canal` deve bater com um dos
    canais de notificação criados no app (ver src/api/notifications.js) —
    é o que decide qual som toca no Android."""
...
def enviar_push_varios(push_tokens: list[str], titulo: str, corpo: str, dados: dict | None = None, canal: str = "padrao1") -> None:
